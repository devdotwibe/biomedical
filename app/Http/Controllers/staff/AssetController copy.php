...
class AssetController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.asset.index', compact('assets','state','district','customer','product_type','products','brand','modality'));
    }
    /**
    ...
    public function show()
    {
       ...
       $brand = DB::table('brand')
        ...
        $modality = Modality::all();
       return view('admin.asset.create', array('state' => $state, 'district' => $district, 'brand' => $brand, 'product_type' => $product_type, 'department' => $department,'products' => $products,'modality' => $modality ));
    }
    /**
    ...
    */
    ...
    public function edit($id)
    {
        ...
        return view('admin.asset.edit',array('customer'=>$user,'asset'=>$asset,'id'=>$id,'state'=>$state,'district'=>$district, 'brand' => $brand, 'product_type' => $product_type, 'department' => $department, 'products' => $products,'state' => $state, 'district' => $district,'modality' => $modality ));
    }
    /**
