...
CKEDITOR.editorConfig = function( config ) {
	...
	config.extraPlugins = 'mediaembed,oembed,widget,lineutils';
	...
	config.toolbar_Full = [
		...
		{ name: 'insert', items: [ 'Image','MediaEmbed', 'oembed', 'Flash', 'Table', 'HorizontalRule', 'Smiley', 'SpecialChar', 'PageBreak', 'Iframe' ] },
		'/',
