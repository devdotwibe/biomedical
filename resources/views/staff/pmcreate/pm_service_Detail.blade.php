            ...
            @foreach ($contractpdt as $k=> $item)
                ...
                <div id="contract-service-{{$k}}">
                    ...
                    <table id="cmsTable" class="mobile_view_table table table-bordered table-striped data-">
                        ...
                        <tbody id="tabledata">
                            <tr> 
                                ...
                                <td class="mobile_view">{{ $item->contract_type }}</td>
                                ...
                                <td class="mobile_view">{{ $item->contract_start_date }}</td>
                                <td class="mobile_view">{{ $item->contract_end_date }}</td>
                                ...
                                <td class="mobile_view">{{ $service->created_at->format('d-m-Y') }}</td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    @endif
                        ...
                        <table id="cmsTable_edit" class="mobile_view_table table table-bordered table-striped data-">
                            <thead>
                                <tr>
                                ...
                                @if (!empty($pmDates) && is_array($pmDates) && count($pmDates) > 0)
                                    @foreach ($pmDates as $index => $date)
                                      @if ($staff_id == 55 || $staff_id == 127 || $staff_id == 34 || $staff_id == 56 ||$staff_id==(optional($item->productPM("PM".($index+1)))->engineer_name??0))
                                            ...
                                            <th class="mobile_view">
                                                <span> PM {{ $index + 1 }} (Date)</span>
