...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{route('admin.district.index')}}">Manage District</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="box box-primary">
            ...
            <form role="form" name="frm_company" id="frm_company" method="post" action="{{ route('admin.district.update', $district->id) }}" enctype="multipart/form-data" >
               @csrf
               {{method_field('PUT')}}
                <div class="box-body">
                ...
                <div class="form-group ">
                  ...
                  <?php
                  $sel = ($district->country_id == $values->id) ? 'selected': '';
                ...
                <div class="form-group ">
                  ...
                  <?php
                  $sel = ($district->state_id == $values->id) ? 'selected': '';
                  echo '<option value="'.$values->id.'" '.$sel.'>'.$values->name.'</option>';
                  ?>
                  <!-- <option value="{{$values->id}}">{{$values->name}}</option> -->
                  @endforeach
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="name" name="name" class="form-control" value="{{$district->name}}" placeholder="District">
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-primary">Submit</button>
                 <button type="button" class="btn btn-danger" onClick="window.location.href='{{route('admin.district.index')}}'">Cancel</button>
              </div>
            </form>
          </div>
