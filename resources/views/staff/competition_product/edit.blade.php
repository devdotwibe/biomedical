      ...
      <div class="row">
        ...
        <div class="col-md-10">
          ...
          <div class="box box-primary">
            ...
            <form role="form" name="frm_subcategory" id="frm_subcategory" method="post" action="{{ route('staff.competition_product.update', $competition_product->id) }}" enctype="multipart/form-data" >
               @csrf
               {{method_field('PUT')}}
                <div class="box-body">
