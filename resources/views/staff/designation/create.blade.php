...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{route('admin.brand.index')}}">Manage Designation</a></li>
       ...
       <div class="col-md-3 leftside-menu">
        ...
        <div class="col-md-9">
          ...
          <div class="box box-primary">
            ...
            <form role="form" name="frm_designation" id="frm_designation" method="post" action="{{route('admin.designation.store')}}" enctype="multipart/form-data" >
               @csrf
                <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="name" name="name" value="{{ old('name')}}" class="form-control" placeholder="Designation Name">
