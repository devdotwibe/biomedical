...
<div class="col-md-10"  >
  ...
  <form name="contactformeditopper" id="contactformeditopper" method="post" action="{{url('staff/send_mail')}}">
    ...
    <div class="form-group col-md-10">
      <label>Subject*</label>
        <input type="text" id="subject" name="subject" class="form-control" required="" value="{{isset($hospital->business_name)?ucfirst($hospital->business_name)." - ":""}} Quote Details">
    ...
    <div class="form-group col-md-10">
      ...
      <textarea name="comment" placeholder="Add Comment" id="comment" rows="3" class="form-control ays-ignore" required="" >
        ...
        @if ($opp_type == 5)
        {!! setting('QUOTE_MAIL_CONTENT') !!}
        @elseif($opp_type == 6)
        {!! setting('QUOTE_MAIL_CONTENT_BEC') !!}
        @else
        {!! setting('TECHSURE_QUOTE_MAIL_CONTENT') !!}
        @endif
    ...
    @elseif($opp_type == 6)
    {{ setting('BEC_QUOTE_Mail') }}
    @else
    {{ setting('TECHSURE_QUOTE_MAIL_CONTENT_FOOTER') }}
    @endif
    ...
    <div class="form-group col-md-10">
      ...
      <input type="button" id="submit_email" value="Submit" class="btn btn-info mtop10 pull-left" >     
