      ...
      <div class="row">
               ...
               <div class="panel-body padding-10">
                 <h4 class="bold">
                  ...
                  <div>
                    <table class="table table-bordered table-striped data-">
                      ...
                      <tr>
                        <td>{{$i++}}</td>
                        <td><a href="{{url('admin/edit_oppertunity/'.$op->id)}}">{{$op->oppertunity_name}}</a></td>
                      </tr>
                      @endforeach
                      @endif
                    </table>
                ...
                <ul class="nav navbar-pills navbar-pills-flat nav-tabs nav-stacked customer-tabs" role="tablist">
                  <li class="customer_tab_contacts ">
                    <a data-group="contacts" href="{{ url('admin/view_contact/'.$user->id) }}">
        ...
        <div class="col-md-9">
          ...
          <div class="box box-primary">
           ...
           <form role="form" name="frm_user" id="frm_user" method="post" action="{{ route('admin.customer.update', $user->id) }}" enctype="multipart/form-data" >
               @csrf
               {{method_field('PUT')}}
