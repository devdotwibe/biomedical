...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{url('admin/list_oppertunity')}}">Manage Oppertunity</a></li>
            ...
            <form role="form" name="frm_products" id="frm_products" method="post"  enctype="multipart/form-data" >
              ...
              <div class="box-body">
                ...
                <div class="form-group  col-md-6">
                  ...
                  <a href="{{url('admin/customer/'.$oppertunity->customer->id)}}" target='_blank'>Add Contact</a>
                </div>
              ...
              <div class="box-footer col-md-12">
                ...
                <button type="button" class="mdm-btn cancel-btn  " onClick="window.location.href='{{url('admin/prospectus/'.$id)}}'">Cancel</button>
              </div>
            </form>
          </div>
