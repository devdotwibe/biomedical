...
?>
              ...
              <select class="form-control"  name="leave_month" id="leave_month" onchange="change_leave_month(this.value)">
         ...
         var type_expence="office";
          ...
          if(expence[i]["travel_start_image"]!='' && expence[i]["travel_start_image"]!=null)
...

           {
             ...
             var tr_imgs_start="{{asset('storage/app/public/comment/')}}/"+expence[i]["travel_start_image"];
...
{$(".load_travel_end"+row_no).hide();
    ...
    var child_task=[];
       ...
       if(travel[i]["travel_start_image"]!='' && travel[i]["travel_start_image"]!=null)
...

                  {
                    ...
                    var tr_imgs_start="{{asset('storage/app/public/comment/')}}/"+travel[i]["travel_start_image"];
 ...
 htmls +='<td><a href="'+tr_imgs_start+'" download="'+tr_imgs_start+'"><img src="'+tr_imgs_start+'" width="50px" height="50px;"/>Download</a></td>';
...

                  {
                    ...
                    var tr_imgs_end="{{asset('storage/app/public/comment/')}}/"+travel[i]["travel_end_image"];
