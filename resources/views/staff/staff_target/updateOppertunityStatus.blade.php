...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            <div class="form-check">
                <input class="form-check-input approve_stage @if(empty($lastapprove)||$lastapprove->approve_stage=="New Orders") approve_disabled @endif " type="radio" name="approve_stage" id="approve_stage_2" value="Technical Approval" @if(empty($lastapprove)||$lastapprove->approve_stage=="New Orders") data-ban="true" disabled @elseif($lastapprove->approve_stage=="Initial Check") checked @endif>
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="file" id="approve_attachment" style="display: none">
