      ...
      <div class="row">
        ...
        <div class="col-md-10">
          ...
          <div class="box box-primary">
            ...
            <form role="form" name="frm_subcategory" id="frm_subcategory" method="post" action="{{route('staff.product_type.store')}}" enctype="multipart/form-data" >
               @csrf
                <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="name" name="name" value="{{ old('name')}}" class="form-control" placeholder="Product Type">
