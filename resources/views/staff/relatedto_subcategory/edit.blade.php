...
@section('title', 'Edit Related SubCategory')
...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Related SubCategory</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="box box-primary">
            ...
            <form role="form" name="frm_company" id="frm_company" method="post" action="{{ route('admin.relatedto_subcategory.update', $relatedto_subcategory->id) }}" enctype="multipart/form-data" >
               @csrf
               {{method_field('PUT')}}
                <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="name" name="name" class="form-control" value="{{$relatedto_subcategory->name}}" placeholder="Name">
                 ...
                 <div class="form-group">
                  ...
                  <select name="relatedto_category_id" id="relatedto_category_id" class="form-control">
                    ...
                    foreach($rel_category as $item) {
                      $sel = ($relatedto_subcategory->relatedto_category_id == $item->id) ? 'selected': '';
                ...
                <div class="form-group">
                  ...
                  <div class="radio">
                    <label>
                      <input type="radio" name="status" id="status1" value="Y" <?php echo ($relatedto_subcategory->status == 'Y') ? 'checked': '' ?>>
                      Active
                    </label>
                  </div>
                  <div class="radio">
                    <label>
                      <input type="radio" name="status" id="status1" value="N" <?php echo ($relatedto_subcategory->status == 'N') ? 'checked': '' ?>>
                      Inactive
                    </label>
                  </div>
