...
@section('title', 'Add Hospital Designation')

@section('content')

<section class="content-header">
      <h1>
        Add Hospital Designation
      </h1>
      <ol class="breadcrumb">
        ...
        <li class="active">Add Hospital Designation</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="box box-primary">
            ...
            <form role="form" name="frm_company" id="frm_company" method="post" action="{{route('admin.hosdesignation.store')}}" enctype="multipart/form-data" >
               @csrf
                <div class="box-body">
