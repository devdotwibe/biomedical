  ...
  <div class="manage-category">
    <div class="row">
      ...
      @endif
          <!-- /.box-header -->
          <div class="box-body">
            <form name="dataForm" id="dataForm" method="post" action="{{ url('/staff/category_type/deleteAll') }}" />
            @csrf
            ...
            <table id="cmsTable" class="table table-bordered table-striped data-">
              ...
              <tbody>
                <?php $i = 1; ?>
                @foreach ($category_type as $product)
                  <tr id="tr_{{$product->id}}" data-id="{{$product->id}}" data-from="category_type">
        ...
        @endforeach
                ...
                <?php if (count($category_type) > 0) { ?>
                <div class="deleteAll">
                  <a class="btn btn-danger btn-xs btn-bkp" onClick="deleteAll('category_type');" id="btn_deleteAll">
