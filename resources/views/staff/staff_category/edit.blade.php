...
@section('title', 'Edit Staff Category')
...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{route('admin.designation.index')}}">Manage Staff Category</a></li>
        <li class="active">Edit Staff Category</li>
      </ol>
    </section>
       ...
       <div class="col-md-3 leftside-menu">
        ...
        <div class="col-md-9">
          ...
          <div class="box box-primary">
            ...
            <form role="form" name="frm_category" id="frm_category" method="post" action="{{ route('admin.staff_category.update', $staffCategory->id) }}" enctype="multipart/form-data" >
               @csrf
               {{method_field('PUT')}}
                <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="name" name="name" class="form-control" value="{{$staffCategory->name}}" placeholder="Designation Name">
