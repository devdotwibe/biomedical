...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{route('staff.service-index',$type->id)}}">Manage Service</a></li>
        <li class="active">Add {{ $type->name }}</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col">
          ...
          <div class="box box-primary">
            ...
            <div class="prdt-service-box">
            <form role="form" name="frm_service" id="frm_service" method="post" action="{{ route('staff.service-store') }}" enctype="multipart/form-data" >
               @csrf
                ...
                <input type="hidden" id="service_type" name="service_type" value="{{ $type->id }}">
                <div class="form-group col-lg-2 col-md-3 col-sm-4">
                  <label for="name">External Ref No*</label>
                  <input type="text" id="external_ref_no" name="external_ref_no" value="" class="form-control" placeholder="External Ref No">
                ...
                <div class="form-group col-lg-2 col-md-3 col-sm-4">
                  ...
                  <select class="form-control" name="user_id" id="user_id">
                      ...
                      @foreach($users->sortBy('business_name') as $user)
                          @php $sel = (app('request')->input('user_id') == $user->id) ? 'selected' : ''; @endphp
                ...
                <div class="form-group col-lg-2 col-md-3 col-sm-4">
                  ...
                  <input type="text" id="contact_no" name="contact_no" value="" class="form-control" placeholder="Contact Number" readonly>
                ...
                <div class="form-group col-lg-2 col-md-3 col-sm-4">
                  ...
                  <input type="text" id="equipment_status_id" name="equipment_status_id" value="" class="form-control" placeholder="Equipment Status" readonly>
                ...
                <div class="form-group col-lg-2 col-md-3 col-sm-4">
                  ...
                  <select class="form-control" name="machine_status_id" id="machine_status_id">
                      ...
                      @foreach($machine_status->sortBy('name') as $machine_stat)
                          @php $sel = (app('request')->input('machine_status_id') == $machine_stat->id) ? 'selected' : ''; @endphp
              ...
              <div class="form-group col-lg-2 col-md-3 col-sm-4">
                ...
                <select class="form-control" name="engineer_id" id="engineer_id">
                    ...
                    @foreach($staffs->sortBy('name') as $engineer)
                        @php $sel = (app('request')->input('engineer_id') == $engineer->id) ? 'selected' : ''; @endphp
                ...
                <input type="hidden" name="created_by" value="{{ $staff_id }}">
                <div class="form-group col-md-12">
                  <label for="name">Call Details*</label>
                  <textarea id="call_details" name="call_details" class="form-control" placeholder=""></textarea>
              ...
              <div class="box-footer">
                ...
                <button type="button" class="btn btn-danger" onClick="window.location.href='{{route('staff.service-create', $type->id)}}'">Cancel</button>
              </div>
            </form>
            </div>
...
<script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-beta.1/dist/js/select2.min.js"></script>
            ...
            $('#equipment_status_no').val(" ");
                ...
                {       
                  ...
                  $.each(data['equipmentSerial'],function (){ 
                    ...
                    html_equipment_serial+="<option value='"+this.equipment_serial_no+"'>"+this.equipment_serial_no+"</option>"; 
                  });
            ...
            var url = APP_URL+'/staff/customer_contact_detail';
                ...
                {      
                  if(data['contactDetails']['phone'] != '') {
                   // console.log('mobile');
                    $('#contact_no').val(data['contactDetails']['phone']);
                  }else{
  ...
  <script type="text/javascript">
      ...
      function validate_from()
      {
        ...
        {
          $("#equipment_status_no_message").show();
        }
        else{
          $("#equipment_status_no_message").hide();
        }
