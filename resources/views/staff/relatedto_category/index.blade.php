...
@section('title', 'Manage Related Category')

@section('content')

<section class="content-header">
      <h1>
        Manage Related Category
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo URL::to('admin'); ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Manage Related Category</li>
      </ol>
    </section>
       ...
       <div class="col-md-3 leftside-menu">
        ...
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-left">
                ...
                <a class="btn btn-sm btn-success" href="{{ route('relatedto_category.create') }}"> <span class="glyphicon glyphicon-plus"></span>Add Related Category</a>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form name="dataForm" id="dataForm" method="post" action="{{ url('/admin/relatedto_category/deleteAll') }}" />
              @csrf
              ...
              <table id="cmsTable" class="table table-bordered table-striped data-">
                ...
                <tbody>
                    ...
                    <tr id="tr_{{$product->id}}" data-id="{{$product->id}}" data-from ="relatedto_category">
 ...
 -->
                        ...
                        <td class="alignCenter">
                            <a class="btn btn-primary btn-xs" href="{{ route('relatedto_category.edit',$product->id) }}" title="Edit"><span class="glyphicon glyphicon-pencil"></span></a>
                           
                           <a class="btn btn-danger btn-xs deleteItem" href="{{ route('relatedto_category.destroy',$product->id) }}" id="deleteItem{{$product->id}}" data-tr="tr_{{$product->id}}" title="Delete"><span class="glyphicon glyphicon-trash"></span></a>
              ...
              <div class="deleteAll">
                 <a class="btn btn-danger btn-xs" onClick="deleteAll('relatedto_category');" id="btn_deleteAll" >
