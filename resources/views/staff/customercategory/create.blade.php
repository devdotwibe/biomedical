...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add Customer Category</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="box box-primary">
            ...
            <form role="form" name="frm_company" id="frm_company" method="post" action="{{route('admin.customercategory.store')}}" enctype="multipart/form-data" >
               @csrf
                <div class="box-body">
