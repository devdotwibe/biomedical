            ...
            <div class="row">
              ...
              <div class="col-lg-12 margin-tb">
                  ...
                  <div class="pull-left">
                      ...
                      <a class="btn btn-sm btn-success" href="{{ url('staff/create_oppertunity_product/'.$id) }}"> <span class="glyphicon glyphicon-plus"></span>Add Products</a>
                ...
                <tbody>
                    ...
                    @if(sizeof($products)>0)
                      ...
                      <tr id="tr_{{$op->id}}" data-id="{{$op->id}}" data-from ="subcategory" >
                        @if($op->optional==0)
                        <td><input type="checkbox" class="dataCheck" name="ids[]" value="{{$op->id}}" id="check{{$op->id}}" data-id="{{$op->id}}" data-prid="{{$op->product_id}}">
                        ...
                        <td>{{$prod_name}}</td>
                        <td>{{$op->quantity}}</td>
                        <td>{{$op->sale_amount}}</td>
                        <td>{{$op->amount}}</td>
                        <td>
                          <a href="{{url('staff/edit_oppertunity_product/'.$op->id.'/'.$id)}}" class="viewer btn btn-info btn-sm">Edit</a>
                        </td>
                      </tr>
              ...
              <br><br><br>
                ...
                <?php if(count($products) > 0) { ?>
                  ...
                  <div class="deleteAll">
                    ...
                    <a class="btn btn-danger btn-xs"  id="btn_deleteAll" >
                                <span class="glyphicon glyphicon-trash"></span> Delete All Selected
                    </a>
                      @if($op_name->quote_status==0)
                        <a class="btn btn-sm btn-primary" id="btn_quote"> <span class="glyphicon glyphicon-plus"></span>Generate Quote</a>
                      @endif
                  </div>
