      ...
      <div class="hire-content">
        ...
        <div class="secondsec-ser">
          ...
          <div class="job-data" id="hiretype{{$val->id}}">
            ...
            @if($val->delete_reason=='needsupport')
            I am confused, i require technical support.
            @endif
            @if($val->delete_reason=='notinterested')
            I am not interested.
            @endif
            @if($val->delete_reason=='forgetting_eng')
