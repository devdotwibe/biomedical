...
<div class="container-fluid height100"  id="myTabContent">
                ...
                <div class="col-md-12">
                                ...
                                <form autocomplete="off" method="POST" action="" action="" name="saveProfile" id="saveProfile" class="saveProfile" autocomplete="off" >
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="text" id="name" name="name" value="{{ $marketspace->name}}" class="form-control" placeholder="Name">
                                         </div>

                                        <div class="form-group col-md-6">
                                        <label for="last_name">Contact no*</label>
                                        <input type="text" id="phone" name="phone" value="{{ $marketspace->phone}}" class="form-control" placeholder="Contact no">
                                        </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="last_name">Alternative Contact no*</label>
                                                <input type="text" id="alt_contact_no" name="alt_contact_no" value="{{ $marketspace->alt_contact_no}}" class="form-control" placeholder="Alternative Contact no">
                                                </div>
                                            <div class="form-group col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" id="blood_group" name="blood_group" value="{{ $marketspace->blood_group}}" class="form-control" placeholder="Blood Group">
                                                </div>
                                            <div class="form-group col-md-6">
                                           <label for="name">Date of Birth*</label>
                                           <input type="text" id="dob" name="dob" value="{{ $marketspace->dob}}" class="form-control" placeholder="Date of Birth">
                                            </div>
                                        ...
                                        <label for="address1">Permenent Address*</label>
                                        <textarea  id="address1" name="address1"  class="form-control" placeholder="Permenent Address">{{ $marketspace->address1}}</textarea>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <textarea  id="current_address" name="current_address"  class="form-control" placeholder="Current Address">{{ $marketspace->current_address}}</textarea>
                                            </div>
...
<script>
        ...
        $('#dob').datepicker({
                    dateFormat:'yy-mm-dd',
                    changeMonth: true, changeYear: true, yearRange: '1960:+0',maxDate:0
                });
