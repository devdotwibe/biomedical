                            ...
                            <div id="tab_2" class="services-tab__tab-item">
                              @if(count($data_accept)>0)
                              @foreach($data_accept as $val)
                                ...
                                <div class="hire-details">
                                  <div class="hire-content">
                                    ...
                                    <div class="secondsec-ser">
                                      ...
                                      <div class="job-data" id="hiretype{{$val->id}}">
                                        <h5>Phone</h5>
                                        @php echo App\Marketspace::get_staff_name($val->service_staff); @endphp
                                      </div>
                                      ...
                                      <div class="action">
                                        ...
                                        @if($val->status=='Accept' && $marketspace->id==$val->service_staff)
                                        <button class="job-accept job_completed"  data-id="{{$val->id}}">Completed</button> 
                                        @endif
